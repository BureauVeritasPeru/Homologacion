/*
SQLyog Community
MySQL - 5.5.36 : Database - cms-base
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`cms-base` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
(1,'admin','admin','Webmaster','','fishdev@gmail.com',1,1,''),
(2,'martin','asixon','Martín','Bailetti','martinbailetti@gmail.com',1,1,NULL),
(3,'chorri','asixon','Roberto','Flores','chorri@hotmail.com',1,0,NULL);
...
(3,1,'2','','','','','','','0000-00-00 00:00:00',0,0,'','1','pagina-principal/animacion-principal/2','<?xml version=\"1.0\"?>\n<root><item key=\"imagen\" value=\"cms/home/foto/bored.jpg\"/></root>\n','<?xml version=\"1.0\"?>\n<root/>\n','<?xml version=\"1.0\"?>\n<root/>\n','2016-01-25 10:25:05',0,1),
(4,1,'3','tres','','','','','','0000-00-00 00:00:00',0,0,'','1','pagina-principal/animacion-principal/3','<?xml version=\"1.0\"?>\n<root><item key=\"imagen\" value=\"cms/home/foto/php_developer.jpg\"/></root>\n','<?xml version=\"1.0\"?>\n<root/>\n','<?xml version=\"1.0\"?>\n<root/>\n','2016-01-22 17:24:11',0,1),
...
(1,'Nombre del Website','string','SITE_NAME','CMS Demo',1),
...
(6,'Correo Postmaster','email','ADMIN_MAIL','fishdev@gmail.com',1),
...
/*!50003 CREATE */ /*!50003 TRIGGER `tgcms_content_lang` BEFORE UPDATE ON `cms_content_lang` FOR EACH ROW BEGIN
...
/*!50003 CREATE */ /*!50003 TRIGGER `tgcms_section_lang` BEFORE UPDATE ON `cms_section_lang` FOR EACH ROW BEGIN
...
/*!50003 CREATE FUNCTION `fcms_childContentLang`(_contentID INT(6), _langID TINYINT(3)) RETURNS int(6)
BEGIN
...
/*!50003 CREATE FUNCTION `fcms_childSchema`(_schemaID MEDIUMINT) RETURNS int(6)
BEGIN
	DECLARE cntChild INT(6);
	SELECT COUNT(*) INTO cntChild
	FROM cms_schema
...
/*!50003 CREATE FUNCTION `fcms_getStaticUrl`(_contentID INT(10), _langID TINYINT(3), _title VARCHAR(255)) RETURNS varchar(1200) CHARSET latin1
BEGIN
...
/*!50003 CREATE FUNCTION `fcms_parseUrlName`(_url VARCHAR(500)) RETURNS varchar(1000) CHARSET latin1
BEGIN
...
/*!50003 CREATE FUNCTION `fcms_pathContent`(_contentID INT, _langID MEDIUMINT) RETURNS varchar(2000) CHARSET latin1
BEGIN
...
/*!50003 CREATE PROCEDURE `cms_contentlang_insert`(
	p_contentID INT(6), 
	p_langID TINYINT(3), 
	p_title VARCHAR(255), 
...
/*!50003 CREATE PROCEDURE `cms_contentlang_update`(
p_contentID INT(6), 
p_langID TINYINT(3), 
p_title VARCHAR(255), 
p_subTitle VARCHAR(255), 
...
/*!50003 CREATE PROCEDURE `raise_error`(message VARCHAR(255))
    DETERMINISTIC
