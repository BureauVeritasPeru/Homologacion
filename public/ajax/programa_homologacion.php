...
$oRegHomologacion->programDate                       =OWASP::RequestString('programDate');
$oRegHomologacion->hourDate                          =OWASP::RequestString('hourDate');
$oRegHomologacion->hourEndDate                       =OWASP::RequestString('hourEndDate');
$oRegHomologacion->userID                            =OWASP::RequestString('userID');
...
function RegisterForm($oRegHomologacion){
	...
	if(CrmHomologacion::Update3($oRegHomologacion)){
