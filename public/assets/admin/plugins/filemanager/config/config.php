...
$ROOT_DIR=__DIR__.'/../../../../../../';
include $ROOT_DIR.'config/main.php';
...
$config = array(
	...
	*/
	...
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] &&$WEBSITE['ROOT']. ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'],
	...
	|
	*/
	'upload_dir' => $WEBSITE['ROOT'].'userfiles/',
	...
	*/
	...
	//**********************
	'ext_img'                                 => array( 'jpg', 'jpeg', 'png', 'gif', 'bmp', 'tiff', 'svg', 'doc', 'docx', 'rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv', 'html', 'xhtml', 'psd', 'sql', 'log', 'fla', 'xml'), //Images
