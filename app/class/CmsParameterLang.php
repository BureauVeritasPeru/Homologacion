...
class CmsParameterLang extends Database
{
	...
	public static function  getList_Paging($groupID, $langID){
		...
		//Insert data to table
			...
			VALUES('$oParameterLang->parameterID', '$oParameterLang->langID', '$oParameterLang->parameterName', '$oParameterLang->description', '".XMLParser::ParseArray($oParameterLang->attribute)."', '$oParameterLang->active')";
