							...
							<div class="box-body">
								<div class="panel-body">
									<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
										...
										<tbody><?php $list=CrmBien::getList_Paging(); foreach ($list as $oItem) { ?>

											<tr> 
												<td>
													<a href="<?php echo "javascript:Edit(".$oItem->bienID.");"; ?>"><i class="fa fa-edit"></i></a>
													<a href="<?php echo "javascript:Delete(".$oItem->bienID.");"; ?>"><i class="fa fa-remove"></i></a>
												</td>
												<td><?php echo $oItem->description; ?></td>
												<td><?php echo $oItem->registerDate; ?></td>
												<td align="center"><?php echo CrmBien::getState($oItem->state);?></td>
											</tr><?php } ?>
										</tbody>
									</table>
								</div>
