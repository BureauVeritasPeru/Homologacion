                ...
                <table class="table table-bordered table-hover" width='100%' id="dataTables-example">
                  ...
                  <tbody>
                    ...
                    foreach ($list as $oItem) {
                      ?>
                      <tr> 
                        <td><a href="<?php echo "javascript:Edit(".$oItem->categoriaID.");"; ?>"><i class="fa fa-edit"></i></a>
                          <a href="<?php echo "javascript:Delete(".$oItem->categoriaID.");"; ?>"><i class="fa fa-remove"></i></a></td>
                          <td><?php echo $oItem->description; ?></td>
                          <td><?php echo $oItem->registerDate; ?></td>
                          <td align="center"><?php echo CrmCategoria::getState($oItem->state);?></td>
                        </tr>
                        <?php } ?>
                      </tbody>
                    </table>
