          ...
          <div class="box box-default">
            ...
            <div class="card-header">
              <div class="box-header">
                <h2 class="box-title"><i class="fa fa-edit"></i> <?php echo ($MODULE->FormView=="edit")?$obj->profileName:$MODULE->moduleName; ?></h2>
              </div>
            </div>
            <div class="card-body">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="password" class="form-control" type="text" id="password" value="<?php echo $oItem->password; ?>" size="20" maxlength="15">
                  </div>
                </div>
                <div class="form-group">
