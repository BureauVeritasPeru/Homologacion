          ...
          <div class="box box-default">
            ...
            <div class="card-header">
              <div class="box-header">
                <h2 class="box-title"><i class="fa fa-edit"></i>  <?php echo ($MODULE->FormView=="edit")?$oItem->codeFile:$MODULE->moduleName; ?></h2>
              </div>
            </div>
            <div class="card-body">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="typeFile" id="typeFile" class="form-control" autocomplete="off">
                      <option value="0">Seleccione</option><?php $list= CmsParameterLang::getWebList(3, 1); foreach ($list as $obj) { echo "<option value=\"".$obj->parameterID."\""; if($oItem->typeFile == $obj->parameterID){echo " selected ";} echo ">".$obj->parameterName."</option>";}?> 
                    </select>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label ">Codigo de Adjunto</label>
                  <div class="col-sm-10">
                    <input name="codeFile" autocomplete="off" type="text" id="codeFile" class="form-control" value="<?php echo $oItem->codeFile; ?>" >
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label ">Descripcion</label>
                  <div class="col-sm-10">
                    <textarea name="descriptionFile" id="descriptionFile" class="form-control" ><?php echo $oItem->descriptionFile; ?></textarea>
                  </div>
                </div>
                <div class="form-group">
