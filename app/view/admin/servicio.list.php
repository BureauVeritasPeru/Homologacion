                ...
                <table class="table table-bordered table-hover" width='100%' id="dataTables-example">
                  ...
                  <tbody>
                    ...
                    foreach ($list as $oItem) {
                      ?>
                      <tr> 
                        <td><a href="<?php echo "javascript:Edit(".$oItem->servicioID.");"; ?>"><i class="fa fa-edit"></i></a>
                          <a href="<?php echo "javascript:Delete(".$oItem->servicioID.");"; ?>"><i class="fa fa-remove"></i></a></td>
