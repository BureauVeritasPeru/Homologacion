							...
							<div class="box-body">
								<div class="panel-body">
									<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
										...
										<tbody><?php $list=CrmEmail::getList_Paging(); foreach ($list as $oItem) { ?>

											<tr> 
												<td>
													<a href="<?php echo "javascript:Edit(".$oItem->emailID.");"; ?>"><i class="fa fa-edit"></i></a>
													<a href="<?php echo "javascript:Delete(".$oItem->emailID.");"; ?>"><i class="fa fa-remove"></i></a>
												</td>
												<td><?php echo $oItem->title; ?></td>
												<td><?php echo $oItem->registerDate; ?></td>
												<td align="center"><?php echo CrmEmail::getState($oItem->state);?></td>
											</tr><?php } ?>
										</tbody>
									</table>
								</div>
